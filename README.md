...
- Connexion Internet
- Optionnel : [Homebrew](https://brew.sh) pour installer Java automatiquement ; sinon, installer [Java 25](https://adoptium.net/temurin/releases/?version=25) à la main puis relancer le script
